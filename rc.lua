...
shell = {
   { "zsh (the default)", terminal},
   { "bash", terminal .. " -e /bin/bash" },
   { "python 2", terminal .. " -e /usr/bin/python2" },
   { "python 3", terminal .. " -e /usr/bin/python3" },
}
...
mytextclock = awful.widget.textclock("%a %b %d %Y, %I:%M", 1)
