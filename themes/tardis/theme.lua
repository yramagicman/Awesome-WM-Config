-- tardis, awesome3 theme, by zhuravlik, based on Zenburn
...
-- {{{ Styles
theme.font      = "Nimbus Sans L 8"

-- {{{ Colors
theme.fg_normal = "#ffffff"
theme.fg_focus  = "#dddddd"
theme.fg_urgent = "#939393"
theme.bg_normal = "#436f9855"
theme.bg_focus  = "#436f98"
...
theme.border_normal = "#737373"
theme.border_focus  = "#6C6C6C"
